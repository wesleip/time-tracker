...
const navItems = [
  ...
  { to: "/registrar", label: "Registrar", icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" },
        ...
        {user?.isAdmin && (
          <>
            <div className="pt-2 pb-1 px-3">
              <p className="text-xs font-medium text-text-muted uppercase tracking-wider">Administração</p>
            </div>
            <NavLink
              to="/admin"
              onClick={onClose}
